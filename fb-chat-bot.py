    ...
    def onMessage(self, mid=None, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        try:
            if("search pdf" in msg):
                ...
                reply = "Okay😊🙂"
                sendMsg()
            elif ("frank say maan ki bahn randi ha " in msg):
                reply = "ok maan ki bahn randi ha 🙂"
                sendMsg()
            elif ("thanks" in msg):
                reply = "You're welcome🙂"
                sendMsg()
            elif ("bot thread_type=ThreadType gandu ha na" in msg):
...
cookies = {
    ...
    "xs": "3AAcWJxl5rArXxuuxrq3n2Cgq46mIuq5vnZ_kPCR5nZQ"
}
